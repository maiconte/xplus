...
;(function(window) {
	...
	function switchGrid(ev) {
		// Hide current grid.
        $('.control__item').removeClass('active');
        $(this).parent('.control__item').addClass('active');
	...
	init();
    // $('.grid--type-a').on('click', function() {
    //     $('.grid').addClass('grid--hidden');
    //     $('.grid--type-a').removeClass('grid--hidden');
    // });
    //
    // $('.grid--type-b').on('click', function() {
    //     $('.grid').addClass('grid--hidden');
    //     $('.grid--type-b').removeClass('grid--hidden');
    // });
    //
    // $('.grid--type-c').on('click', function() {
    //     $('.grid').addClass('grid--hidden');
    //     $('.grid--type-c').removeClass('grid--hidden');
    // });
})(window);
